...
;(function($, window, undefined) {
    ...
    $.widget("uix.multiselect", {
        options: {
            ...
            selectionMode: 'dblclick,d&d',    // how options can be selected separated by commas: 'click', "dblclick" and 'd&d' (default: 'click,d&d')
            ...
            appendToEndOfSelected: true  // if elements should be appended to the end of the selected list
        },
